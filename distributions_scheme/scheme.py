...
ax.text(0.3, 0.88, r'Гауссовская модель $\mathcal{N}(\mu,\sigma^2)$',
...
ax.text(0.7, 0.88, r'Экспоненциальная модель $\mathrm{Exp}(\lambda)$',
        ha='center', fontsize=14)
...
ax.text(0.15, 0.15, r'$\mathcal{B}(\alpha,\beta)$',
        ha='center', fontsize=16, bbox=dict(facecolor='white', alpha=0.0, edgecolor='none'))
ax.text(0.3, 0.15, r'$\mathcal{N}(\mu,\sigma^2)$',
        ha='center', fontsize=16, bbox=dict(facecolor='white', alpha=0.0, edgecolor='none'))
ax.text(0.45, 0.15, r'$U(a,b)$',
        ha='center', fontsize=16, bbox=dict(facecolor='white', alpha=0.0, edgecolor='none'))
ax.text(0.55, 0.15, r'$Exp(\lambda)$',
        ha='center', fontsize=16, bbox=dict(facecolor='white', alpha=0.0, edgecolor='none'))
ax.text(0.85, 0.15, r'$W(k,\lambda)$',
        ha='center', fontsize=16, bbox=dict(facecolor='white', alpha=0.0, edgecolor='none'))

# Добавляем общее название схемы
ax.text(0.5, 0.97, 'Моделирование распределений',
