...
class CpdSolver:
    ...
    def run(self) -> CpdResults:
        ...
        algo_results = self._cpd_core.localize() if self._scenario.to_localize else self._cpd_core.detect()
        ...
        return CpdResults(data, algo_results, expected_change_points, time_end - time_start)
